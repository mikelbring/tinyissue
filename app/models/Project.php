...
class Project extends Eloquent {
    ...
    */
    ...
    {
        return $this->hasMany('Project\Issue', 'project_id');
    }
    ...
    * @return void
    */
    public function assignUser($user_id, $role_id = 0)
    {
    ...
    {
        return $this->belongsToMany('User', 'projects_users', 'project_id', 'user_id');
    }
    ...
    * @return int
    */
    public function countAssignedIssues($user_id = null)
    {
        if (is_null($user_id))
        {
    ...
    * @return array
    */
    public static function createProject(array $input)
    {
        $rules = array(
