<li id="comment<?php echo $comment->id; ?>" class="comment">
    <div class="insides">
        <div class="topbar">
            ...
            <?php echo trans('tinyissue.commented'); ?> <?php echo date('F jS \a\t g:i A', strtotime($comment->updated_at)); ?>
        </div>
        ...
        <div class="comment-edit">
            ...
            <div class="right">
                <a href="javascript:void(0);" class="action save"><?php echo trans('tinyissue.save'); ?></a>
                <a href="javascript:void(0);" class="action cancel"><?php echo trans('tinyissue.cancel'); ?></a>
            </div>
        </div>
        <?php endif; ?>
