<h3>
    ...
    <?php endif; ?>
    <span><?php echo trans('tinyissue.on_project'); ?> <a href="<?php echo $project->to(); ?>"><?php echo $project->name; ?></a></span>
</h3>
<div class="pad">
        ...
        <li>
            <div class="insides">
                <div class="topbar">
                    ...
                    <?php echo trans('tinyissue.opened_this_issue'); ?>  <?php echo date('F jS \a\t g:i A', strtotime($issue->created_at)); ?>
                </div>
                <div class="issue">
        ...
        <?php if (Auth::user()->permission('issue-modify')): ?>
            <ul class="issue-actions">
                <li class="assigned-to">
                    <?php echo trans('tinyissue.assigned_to'); ?>
                    ...
                    <?php else: ?>
                        <a href="javascript:void(0);" class="currently_assigned">
                            <?php echo trans('tinyissue.no_one'); ?>
                        </a>
                    <?php endif; ?>

                    <div class="dropdown">
                        <ul>
                            <li class="unassigned"><a href="javascript:void(0);" onclick="issue_assign_change(0, <?php echo Project\Issue::current()->id; ?>);" class="user0<?php echo !Project\Issue::current()->assigned ? ' assigned' : ''; ?>"><?php echo trans('tinyissue.no_one'); ?></a></li>
                ...
                <li>
                    <a href="<?php echo Project\Issue::current()->to('status?status=0'); ?>" onclick="return confirm('<?php echo trans('tinyissue.close_issue_confirm'); ?>');" class="close"><?php echo trans('tinyissue.close_issue'); ?></a>
                </li>
            </ul>
        <?php endif; ?>

        <h4><?php echo trans('tinyissue.comment_on_this_issue'); ?></h4>
        <form method="post">
            <p>
            ...
            <p><input id="upload" type="file" name="file_upload" /></p>
            <ul id="uploaded-attachments"></ul>
            <p style="margin-top: 10px;">
                <input type="submit" class="button primary" value="<?php echo trans('tinyissue.comment'); ?>" />
            </p>
    ...
    <?php else: ?>
    <?php echo HTML::link(Project\Issue::current()->to('status?status=1'), trans('tinyissue.reopen_issue')); ?>
    <?php endif; ?>
</div>
