<h3>
    <?php echo trans('tinyissue.create_a_new_project');?>
    <span><?php echo trans('tinyissue.create_a_new_project_description');?></span>
</h3>
<div class="pad">
    <form method="post" action="" id="submit-project">
        ...
        <ul class="assign-users" style="display: none">
            <li class="project-user<?php echo Auth::user()->id; ?>">
                <a href="javascript:void(0);" onclick="$('.project-user<?php echo Auth::user()->id; ?>').remove();" class="delete"><?php echo trans('tinyissue.remove');?></a>
    ...
    <table class="form" style="width: 80%;">
        <tr>
            <th style="width: 10%;"><?php echo trans('tinyissue.assign_users');?></th>
            <td>
        ...
        <tr>
            <th></th>
            <td><input type="submit" onclick="$('#submit-project').submit();" value="<?php echo trans('tinyissue.create_project');?>"  /></td>
        </tr>
    </table>
</div>
