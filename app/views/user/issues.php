<h3>
    <?php echo trans('tinyissue.your_issues'); ?>
    <span><?php echo trans('tinyissue.your_issues_description'); ?></span>
</h3>
                ...
                <li>
                    ...
                    <div class="data">
                        ...
                        <div class="info">
                            ...
                            - <?php echo trans('tinyissue.updated_by'); ?> <strong><?php echo $row->updated->firstname . ' ' . $row->updated->lastname; ?></strong>
