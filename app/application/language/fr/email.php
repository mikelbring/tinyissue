...
return array(
	...
	/** issue updates **/
	'new_issue' => 'Un nouveau ticket "%s" a été créé pour le projet "%s"',
	'new_comment' => 'Le ticket "%s" du projet "%s" a un nouveau commentaire',
	'assignment' => 'Un nouveau ticket "%s" a été créé pour le projet "%s" et vous a été assigné.',
	'reassignment' => 'Le ticket "%s" du projet "%s" vous a été réassigné',
	'update' => 'Le ticket "%s" du projet "%s" a été mis à jour',
	...
	'issue_changed' => 'Le ticket "%s" du projet "%s" a été %s',
	'closed' => 'fermé',
	'reopened' => 'réouvert',
