<div style="display: block ; " id="div_reporttous">
	...
	<div class="stat">
		...
		<div class="stat_data stat_custom_data" onclick="document.getElementById('input_Couleur').value='cf55c3'; document.getElementById('div_reportcustom').style.display = 'block'; document.getElementById('div_reporttous').style.display = 'none';" style="margin-top: 150px;">
