	...
	<form method="post" action="">
		...
		<table class="form">
			<tr>
				...
				<td>
					<input type="text" name="firstname" value="<?php echo Input::old('firstname', htmlspecialchars($user->firstname)); ?>" autocomplete="off" style="width: 300px;" />
			...
			<tr>
				...
				<td>
					<input type="text" name="lastname" value="<?php echo Input::old('lastname', htmlspecialchars($user->lastname)); ?>" autocomplete="off" style="width: 300px;" />
