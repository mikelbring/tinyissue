			...
			<li class="sortable-li" data-issue-id="<?php echo $row->id; ?>">
				...
				<div class="data">
					...
					echo '<br /><br />'; 
						...
						if (is_object($Etat)) { 
						echo '<div style="position: relative; top: -11px; left: 0; background-color: green; color:white; width: '.($Etat->weight*$SizeX).'px; height: 4px; line-height:4px;" /></div>'; 
						echo '<div style="position: relative; top: -15px; left: '.(0 + ($Etat->weight*$SizeX)).'px; margin-bottom: -4px; background-color: gray; color:white; width: '.($SizeXtot-($Etat->weight*$SizeX)).'px; height: 4px; text-align: center; line-height:4px;" /></div>';
						}
