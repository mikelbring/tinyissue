...
<?php foreach(Project::current()->users()->get() as $row): ?>
	<li id="project-user<?php echo $row->id; ?>">
		...
		<a href="javascript:void(0);" onclick="remove_project_user(<?php echo $row->id; ?>, <?php echo Project::current()->id; ?>, '<?php echo __('tinyissue.ProjSuppMbre'); ?>');" class="delete"><?php echo __('tinyissue.remove');?></a>
		<?php endif; ?>
